...
INSERT INTO funcionarios (nome, cargo, salario, cpf, telefone, lojaID) VALUES 
    ('Samanta', 'atendente', 1.600, 12345678995, 123, 1),
    ('Thayla', 'Gerente', 4.600, 21354687933, 123, 1),
    ('Gabriel', 'atendente', 1.600, 87954622200, 123, 2),
    ('Pedro', 'Gerente', 4.600, 54687922211, 123, 2),
    ('Luana', 'atendente', 1.600, 22221354687900, 123, 3),
    ('Larissa', 'Gerente', 4.600, 54633387911, 123, 3),
    ('Luana', 'atendente', 1.600, 22221354687900, 123, 4),
    ('Larissa', 'Gerente', 4.600, 54633387911, 123, 4),
    ('André', 'atendente', 1.600, 99974201366, 123, 5),
    ('Samuel', 'Gerente', 4.600, 88874952100, 123, 5),
    ('Fabricio', 'atendente', 1.600, 55564187900, 123, 6),
    ('Guilherme', 'Gerente', 4.600, 22211130455, 123, 6);
...
INSERT INTO clientes (nome, cpf, email, endereco, lojaID, funcionarioID) VALUES 
    ...
    ('Tânia Maria', 21354687900, 'tania@gmail.com','Rua das palmeiras, 988', 6, 11),
    ('Josi das Graças', 78965412300, 'josi@gmail.com', 'Rua das flores, 166', 6, 12);